...
namespace polygon{
    ...
    class PolygonIntersecting{
        ...
        private:
            ...
            bool isSmallerorBiger(const polygon::Polygon<T>* ptr, const bool& isclockwise, const int& last_count, int& cur_count); // can change the curcount to avoid all points in a line .
    };
}
